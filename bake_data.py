...
def api_finalizar_venta():
    ...
    try:
        ...
        with connection.cursor(pymysql.cursors.DictCursor) as cursor:
            ...
            # 1. Insertar en VENTA
            sql_venta = "INSERT INTO VENTA (venta_emp_fk, venta_caja_fk, venta_suc_fk, venta_fecha, venta_monto_total, venta_sucursal) VALUES (%s, %s, %s, %s, %s, %s)"
            today = date.today()
            cursor.execute(sql_venta, (empleado_id, caja_id, sucursal_id, today, monto_total_venta,sucursal_nombre))
